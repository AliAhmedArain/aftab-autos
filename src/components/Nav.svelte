...
<div class="container-fluid p-0">
              ...
              >
                    ...
                    <li class="nav-item mb-2 border-bottom">
                        <a
                                ...
                                href="#menu-setup"
                        >
                            <span><i class="fa-sharp-duotone fa-solid fa-gear mr-2"
                                     style="font-size: 20px;"></i>SETUP</span>
                            <span class="fw-bold">+</span>
                        </a>
    ...
    <nav class="navbar navbar-light border-bottom p-0 m-0 custom-bg-c d-none d-lg-flex ">
        ...
        <div class="ml-auto d-flex align-items-center">
            <!-- Support Dropdown -->
            <div class="dropdown">
                <a href="#" class="nav-link d-flex align-items-center text-muted" id="userDropdown1" role="button"
            ...
            <!-- Create Dropdown -->
            <div class="dropdown">
                <a href="#" class="nav-link d-flex align-items-center text-muted" id="userDropdown2" role="button"
                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <!-- Setup Dropdown -->
            <div class="dropdown ">
                <a href="#" class="nav-link d-flex align-items-center text-muted" id="userDropdowns" role="button"
                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-start" aria-labelledby="userDropdowns">
                    <div>
                        ...
                        <a href="#/customer" class="dropdown-item px-4">Customer</a>
                        <a href="#/Vendor" class="dropdown-item px-4">Vendors</a>
                        <a class="dropdown-item px-4" href="#/Products">Products</a>
                        <a class="dropdown-item px-4" href="#/User">Users</a>
                    </div>
                    <div>
                        <h6 class="dropdown-header">Categories</h6>
                        <a class="dropdown-item px-4" href="#/customerCate">Customer Categories</a>
                        <a class="dropdown-item px-4" href="#/vendorcate">Vendor Categories</a>
                        <a class="dropdown-item px-4" href="#/productcate">Product Categories</a>
                        <a class="dropdown-item px-4" href="#/brand">Brands</a>
                    </div>
                    <div>
                        <h6 class="dropdown-header">General</h6>
                        <a class="dropdown-item px-4" href="#/tax">Tax</a>
                        <a class="dropdown-item px-4" href="#/discount">Discounts</a>
                        <a class="dropdown-item px-4" href="#/warehouse">Warehouses</a>
                        <a class="dropdown-item px-4" href="#/mpl">Multiple Price Levels</a>
                    </div>
                    <div>
                        <h6 class="dropdown-header">Payroll</h6>
                        <a class="dropdown-item px-4" href="#/employ">Employees</a>
                    </div>
                </div>
            </div>
            ...
            <!-- User Dropdown -->
            <div class="dropdown">
                <a href="#" class="nav-link dropdown-toggle d-flex align-items-center text-muted" id="userDropdown"
