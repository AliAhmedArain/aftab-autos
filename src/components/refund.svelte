    ...
    <div class="p-3 border-bottom">
        <div class="row align-items-center mb-3">
            <div class="col-12 mb-2">
                <h2 class="h4">Customer Refunds</h2>
            </div>
            <div class="col-12">
                <a href="#/addcustomerrefund" class="btn btn-success">+ Add Customer Refunds</a>
            </div>
        </div>
        <div class="row align-items-center mb-4">
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex flex-md-row justify-content-md-end gap-2">
                    ...
                    <button class="btn btn-success">Other Action</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-block d-md-none">
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p><strong>Reference:</strong> H</p>
                <p><strong>Total Amount:</strong></p>
                <p><strong>Unadjusted Amount:</strong> 0</p>
